...
public class PuzzleCC2Test {
    ...
    public void testPuzzleConstructorWithDimensions() {
        ...
        // Test tilt method
        puzzle1.tilt();
        assertFalse(puzzle1.ok(), "Shouldn't be able to tilt smart.");
    ...
    **/
    ...
    public void testPuzzleConstructorWithStartingAndEndingMatrices() {
        ...
        // Test tilt method
        puzzle2.tilt();
        assertFalse(puzzle2.ok(), "Shouldn't be able to tilt smart.");
