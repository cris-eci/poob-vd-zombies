...
public class PuzzleCC1Test {
    ...
    **/
    ...
    public void testPuzzleConstructorWithStartingAndEndingMatrices() {
        ...
        puzzle2.makeVisible();
        assertTrue(puzzle2.ok(), "Puzzle should be visible.");

        // Add several tiles
        puzzle2.addTile(1, 0, 'r');
        assertTrue(puzzle2.ok(), "Should be able to add a red tile at (1,0).");

        puzzle2.addTile(9, 0, 'g');
        assertTrue(puzzle2.ok(), "Should be able to add a green tile at (0,9).");

        // Delete a tile
        puzzle2.deleteTile(0, 0);
        assertTrue(puzzle2.ok(), "Should be able to delete the tile at (0,0).");
        
        puzzle2.deleteTile(0,2);
        assertTrue(puzzle2.ok(), "Should be able to delete the tile at (0,2).");

        
        // Relocate a tile
        puzzle2.addTile(1, 2, 'b');
        puzzle2.relocateTile(new int[]{1, 2}, new int[]{0, 7});
        assertTrue(puzzle2.ok(), "Should be able to relocate the tile from (1,2) to (0,7).");


        // Add and delete glue
        puzzle2.addGlue(0, 7);
        assertTrue(puzzle2.ok(), "Should be able to add glue at (0,7).");
        
        // Perform a tilt
        puzzle2.tilt('d'); // Downwards
        assertTrue(puzzle2.ok(), "Should be able to perform a tilt downwards.");
        
        // Perform a tilt
        puzzle2.tilt('l'); // Downwards
        assertTrue(puzzle2.ok(), "Should be able to perform a tilt to the left.");
        

        // Attempt to add glue to an empty position
        puzzle2.addGlue(2, 2);
        assertFalse(puzzle2.ok(), "Should be able to add glue at (2,2).");
        ...
        assertTrue(puzzle2.ok(), "Puzzle should be invisible.");
        ...
        // Finish puzzle (commented to avoid program termination)
        puzzle2.finish();
        assertTrue(puzzle2.ok(), "Puzzle should finish correctly.");
    }
